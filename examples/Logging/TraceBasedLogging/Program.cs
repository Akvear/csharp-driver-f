...
{
    /// <summary>
    /// This example demonstrates how to configure logging in the ScyllaDB C# RS Driver.
    /// </summary>
    internal class Program
    {
        ...
        private async Task MainAsync(string[] args)
        {
            ...
            // Otherwise, the log level will remain at its default (Off) and no logs will be emitted.
